...
var AccordionLinkDirective = function () {
  ...
  Object.defineProperty(AccordionLinkDirective.prototype, "open", {
    ...
    set: function set(value) {
      this._open = value; //for slimscroll on and off
...
__decorate([core_1.Input()], AccordionLinkDirective.prototype, "group", void 0);

__decorate([core_1.HostBinding('class.pcoded-trigger'), core_1.Input()], AccordionLinkDirective.prototype, "open", null);

AccordionLinkDirective = __decorate([core_1.Directive({
  selector: '[appAccordionLink]'
}), __param(0, core_1.Inject(accordion_directive_1.AccordionDirective))], AccordionLinkDirective);
