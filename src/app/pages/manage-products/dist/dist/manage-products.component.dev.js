...
function () {
  ...
  ManageProductsComponent.prototype.getProduct = function () {
    ...
    this.api.post('products/getById', param).then(function (data) {
      ...
      if (data && data.status === 200 && data.data.length) {
        var info = data.data[0]; // if(this.id == info.parent_id){
        ...
        _this.api.post('subcate/getByCId', subCate).then(function (sub) {
          console.log(sub);
  ...
  ManageProductsComponent.prototype.close2 = function () {
    var _this = this;
  ...
  __decorate([core_1.ViewChild('contentSub', {
    "static": false
  })], ManageProductsComponent.prototype, "contentSub");

  __decorate([core_1.ViewChild('contentVarient', {
    "static": false
  })], ManageProductsComponent.prototype, "contentVarient");

  ManageProductsComponent = __decorate([core_1.Component({
